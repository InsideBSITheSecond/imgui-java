...
public final class ImPlot {
    ...
    */
    ...
    public static void plotInfLines(final String labelId, final short[] values, final int count, final int flags, final int offset, final int stride) {
        nPlotInfLines(labelId, values, count, flags, offset, stride);
    }
    ...
    */
     ...
     * Plots infinite vertical or horizontal lines (e.g. for references or asymptotes).
     */
    public static void plotInfLines(final String labelId, final int[] values, final int count, final int flags, final int offset, final int stride) {
        nPlotInfLines(labelId, values, count, flags, offset, stride);
    }
    ...
    */
     ...
     * Plots infinite vertical or horizontal lines (e.g. for references or asymptotes).
     */
    public static void plotInfLines(final String labelId, final long[] values, final int count, final int flags, final int offset, final int stride) {
        nPlotInfLines(labelId, values, count, flags, offset, stride);
    }
    ...
    */
     ...
     * Plots infinite vertical or horizontal lines (e.g. for references or asymptotes).
     */
    public static void plotInfLines(final String labelId, final float[] values, final int count, final int flags, final int offset, final int stride) {
        nPlotInfLines(labelId, values, count, flags, offset, stride);
    }
    ...
    */
     ...
     * Plots infinite vertical or horizontal lines (e.g. for references or asymptotes).
     */
    public static void plotInfLines(final String labelId, final double[] values, final int count, final int flags, final int offset, final int stride) {
        nPlotInfLines(labelId, values, count, flags, offset, stride);
    }
...
//                                           double radius,
    ...
    */
     ...
     */
    public static double plotHistogram(final String labelId, final short[] values, final int bins, final double barScale, final ImPlotRange range, final ImPlotHistogramFlags flags) {
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final short[] values, final int bins, final double barScale, final double rangeMin, final double rangeMax, final ImPlotHistogramFlags flags) {
    ...
    */
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final int[] values, final int bins, final double barScale, final ImPlotRange range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, range.min, range.max, flags);
    }
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final int[] values, final int bins, final double barScale, final double rangeMin, final double rangeMax, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, rangeMin, rangeMax, flags);
    }
    ...
    */
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final long[] values, final int bins, final double barScale, final ImPlotRange range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, range.min, range.max, flags);
    }
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final long[] values, final int bins, final double barScale, final double rangeMin, final double rangeMax, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, rangeMin, rangeMax, flags);
    }
    ...
    */
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final float[] values, final int bins, final double barScale, final ImPlotRange range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, range.min, range.max, flags);
    }
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final float[] values, final int bins, final double barScale, final double rangeMin, final double rangeMax, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, rangeMin, rangeMax, flags);
    }
    ...
    */
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final double[] values, final int bins, final double barScale, final ImPlotRange range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, range.min, range.max, flags);
    }
     ...
     * If #range is specified, outlier values outside of the range are not binned. However, outliers still count toward normalizing and cumulative counts unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram(final String labelId, final double[] values, final int bins, final double barScale, final double rangeMin, final double rangeMax, final ImPlotHistogramFlags flags) {
        return nPlotHistogram(labelId, values, bins, barScale, rangeMin, rangeMax, flags);
    }
    ...
    */
     ...
     */
    public static double plotHistogram2D(final String labelId, final short[] xs, final short[] ys, final int xBins, final int yBins, final ImPlotRect range, final ImPlotHistogramFlags flags) {
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final short[] xs, final short[] ys, final int xBins, final int yBins, final double rangeMinX, final double rangeMinY, final double rangeMaxX, final double rangeMaxY, final ImPlotHistogramFlags flags) {
    ...
    */
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final int[] xs, final int[] ys, final int xBins, final int yBins, final ImPlotRect range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, range.x.min, range.y.min, range.x.max, range.y.max, flags);
    }
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final int[] xs, final int[] ys, final int xBins, final int yBins, final double rangeMinX, final double rangeMinY, final double rangeMaxX, final double rangeMaxY, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, rangeMinX, rangeMinY, rangeMaxX, rangeMaxY, flags);
    }
    ...
    */
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final long[] xs, final long[] ys, final int xBins, final int yBins, final ImPlotRect range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, range.x.min, range.y.min, range.x.max, range.y.max, flags);
    }
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final long[] xs, final long[] ys, final int xBins, final int yBins, final double rangeMinX, final double rangeMinY, final double rangeMaxX, final double rangeMaxY, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, rangeMinX, rangeMinY, rangeMaxX, rangeMaxY, flags);
    }
    ...
    */
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final float[] xs, final float[] ys, final int xBins, final int yBins, final ImPlotRect range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, range.x.min, range.y.min, range.x.max, range.y.max, flags);
    }
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final float[] xs, final float[] ys, final int xBins, final int yBins, final double rangeMinX, final double rangeMinY, final double rangeMaxX, final double rangeMaxY, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, rangeMinX, rangeMinY, rangeMaxX, rangeMaxY, flags);
    }
    ...
    */
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final double[] xs, final double[] ys, final int xBins, final int yBins, final ImPlotRect range, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, range.x.min, range.y.min, range.x.max, range.y.max, flags);
    }
     ...
     * However, outliers still count toward the normalizing count for density plots unless #outliers is false. The largest bin count or density is returned.
     */
    public static double plotHistogram2D(final String labelId, final double[] xs, final double[] ys, final int xBins, final int yBins, final double rangeMinX, final double rangeMinY, final double rangeMaxX, final double rangeMaxY, final ImPlotHistogramFlags flags) {
        return nPlotHistogram2D(labelId, xs, ys, xBins, yBins, rangeMinX, rangeMinY, rangeMaxX, rangeMaxY, flags);
    }
    ...
    */
     ...
     * Plots a centered text label at point x,y with an optional pixel offset. Text color can be changed with ImPlot::PushStyleColor(ImPlotCol_InlayText, ...).
     */
    public static void plotText(final String text, final double x, final double y, final float pixOffsetX, final float pixOffsetY, final ImPlotTextFlags flags) {
        nPlotText(text, x, y, pixOffsetX, pixOffsetY, flags);
    }

    private static native void nPlotText(String text, double x, double y, float pixOffsetX, float pixOffsetY, ImPlotTextFlags flags); /*MANUAL
        auto text = obj_text == NULL ? NULL : (char*)env->GetStringUTFChars(obj_text, JNI_FALSE);
        ImVec2 pixOffset = ImVec2(pixOffsetX, pixOffsetY);
        ImPlot::PlotText(text, x, y, pixOffset, false);
    ...
    */
    ...
    public static void colormapScale(final String label, final double scaleMin, final double scaleMax, final ImVec2 size, final String format, final ImPlotColormapScaleFlags flags, final int cmap) {
        nColormapScale(label, scaleMin, scaleMax, size.x, size.y, format, flags, cmap);
    }

    /**
     * Shows a vertical color scale with linear spaced ticks using the specified color map. Use double hashes to hide label (e.g. "##NoLabel").
     */
    public static void colormapScale(final String label, final double scaleMin, final double scaleMax, final float sizeX, final float sizeY, final String format, final ImPlotColormapScaleFlags flags, final int cmap) {
        nColormapScale(label, scaleMin, scaleMax, sizeX, sizeY, format, flags, cmap);
    }

    private static native void nColormapScale(String label, double scaleMin, double scaleMax, float sizeX, float sizeY, String format, ImPlotColormapScaleFlags flags, int cmap); /*MANUAL
        auto label = obj_label == NULL ? NULL : (char*)env->GetStringUTFChars(obj_label, JNI_FALSE);
        auto format = obj_format == NULL ? NULL : (char*)env->GetStringUTFChars(obj_format, JNI_FALSE);
        ImVec2 size = ImVec2(sizeX, sizeY);
        ImPlot::ColormapScale(label, scaleMin, scaleMax, ImVec2(0,0), format, true, IMPLOT_AUTO);
        if (label != NULL) env->ReleaseStringUTFChars(obj_label, label);
